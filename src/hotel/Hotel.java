...
public class Hotel {
	...
	public static void main(String args[]) throws ParseException {
		...
		Quarto[] qtdQuartos = new Quarto[3];
		qtdQuartos[0] = new Quarto("Suite Familia", "Acomodação Familiar", 350.00, 60.2, 10);
		qtdQuartos[1] = new Quarto("Suite Master", "Acomodação Master", 250.00, 50.0, 5);
		qtdQuartos[2] = new Quarto("Suite Premium", "Acomodação Premium", 450.00, 70.5, 8);
		...
		switch (opcao) {
			case 1:
				System.out.println(qtdQuartos[0].getNomeQuarto());
				break;

			case 2:
				System.out.println(qtdQuartos[1].getNomeQuarto());
				break;

			case 3:
				System.out.println(qtdQuartos[2].getNomeQuarto());
				break;
				...
				case 1:
					...
					if (i < 20) {
						...
						if (quartos[i] == 0) {
							...
							System.out.println("Digite a Entrada no Hotel ( dd/MM/yyyy )");
							...
							try {
								...
								double totalReserva = (days * qtdQuartos[opcao].getValorDiaria());
